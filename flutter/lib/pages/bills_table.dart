...
class BillsTable extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _BillsTableState();
}
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(
        ...
        cells: <DataCell>[
          ...
          DataCell(Image.network('https://cdn.jsdelivr.net/gh/flutterchina/website@1.0/images/homepage/screenshot-2.png')),
        ]);
  }
